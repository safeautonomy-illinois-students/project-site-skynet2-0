...
ahead of time. These positions can be defined in the world coordinate frame as part of 
the course setup. Since the drone’s pose is estimated using the motion capture system, 
we can compare its current position to the known positions of the gates to determine 
where it should go next. We will pass the known gate coordinates can be passed directly 
